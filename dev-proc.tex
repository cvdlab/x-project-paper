...
{\bf 4\textsuperscript{th} step - UI component assemplation}. Previously defined UI component are finally mounted to compose the application views. Assembly should be kept as simple as possible, in the case of \brand{x-project} toolkit, it only consists of a composition of HTML5 elements.
