...
In this paper a software toolkit named \brand{x-project} is introduced. It consists of a Web Component library which, applied over a very powerful web framework, i.e. Loopback by Strongloop, realizes an hybrid prototypal tool which brings together the customizability of a modern web framework with the ease of use of traditional CMSs.
