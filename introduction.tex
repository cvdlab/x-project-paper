...
The remainder of this document is organized as follows. Section~\ref{sec:architecture} describes the architecture of applications developed by the \brand{x-project} toolkit, while section~\ref{sec:toolkit} presents the toolkit itself. Section~\ref{sec:dev-proc} outlines the development process implicitly defined by the toolkit. Finally section~\ref{sec:case-study} shows how the toolkit can be used to build an application.
