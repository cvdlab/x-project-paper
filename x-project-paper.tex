...
Furthermore, the introduction of this tool implicitly defines a document-driven development process that leads to a very readable, maintenable and extendible code by imposing a neat logic decomposition that strongly supports an engineeared design of the web application.
\end{abstract}
