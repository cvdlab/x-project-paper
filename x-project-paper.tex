...
Furthermore, the introduction of this tool implicitly defines a document-driven development process that lead to a very readable, manutenible and extendible code, imposing a neat logic decomposition that strongly supports an engineeared design of the web application.
\end{abstract}
